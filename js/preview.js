...
var windowHalfX = $("#canvas").innerWidth();
var windowHalfY = $("#canvas").innerHeight();
...
function init() {
   ...
   var refCube = new THREE.CubeTextureLoader()['setPath']('img/')['load'](['px.jpg', 'nx.jpg', 'py.jpg', 'ny.jpg', 'pz.jpg', 'nz.jpg']);
    ...
    camera = new THREE.PerspectiveCamera(30, $("#canvas").innerWidth() / $("#canvas").innerHeight(), 1, 20000);
...
function onWindowResize() {
    windowHalfX = $("#canvas").innerWidth() ;
    windowHalfY = $("#canvas").innerHeight();
...
function expand(){
	newwindow=window.open("preview.html","_blank");//'name','height=600,width=800'
	if (window.focus) {
			newwindow.focus();
		}
}
